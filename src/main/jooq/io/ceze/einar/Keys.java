...
public class Keys {
    ...
    public static final UniqueKey<TokensRecord> TOKENS_PKEY = Internal.createUniqueKey(Tokens.TOKENS, DSL.name("tokens_pkey"), new TableField[] { Tokens.TOKENS.TOKEN_ID }, true);
    ...
    public static final ForeignKey<TokensRecord, UsersRecord> TOKENS__TOKENS_USER_ID_FKEY = Internal.createForeignKey(Tokens.TOKENS, DSL.name("tokens_user_id_fkey"), new TableField[] { Tokens.TOKENS.USER_ID }, Keys.USERS_PKEY, new TableField[] { Users.USERS.USER_ID }, true);
}
