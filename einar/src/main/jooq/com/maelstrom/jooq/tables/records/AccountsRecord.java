...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record4<Integer, String, String, LocalDateTime> {
    ...
    @Override
    public AccountsRecord value4(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public AccountsRecord values(Integer value1, String value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AccountsRecord(Integer accountId, String name, String email, LocalDateTime createdAt) {
        super(Accounts.ACCOUNTS);
